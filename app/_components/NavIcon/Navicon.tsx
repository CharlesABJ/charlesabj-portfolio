...
function Navicon({ dataNavicon }: NaviconProps) {
    return (
        <>
            {/* homeIcon */}
            {dataNavicon.icon === "home" &&
                <svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
